...
객실 번호 선택 ➡️ 룸서비스 / 물품 메뉴 선택 및 주문 ➡️ 수량 변경 및 요청 사항 입력 ➡️ 결제 방식 선택 (즉시 결제 / 나중 결제) ➡️ 주문 완료
...
주문 목록 실시간 확인 ➡️ 주문 상태 변경 (접수 → 준비 → 배달 → 완료) ➡️ 메뉴 · 물품 관리 ➡️ 로봇 상태 확인 (배터리 · 위치) ➡️ 로봇 호출 (특정 객실로 이동 명령)
...
<img width="769" height="296" alt="스크린샷 2025-11-18 145134" src="https://github.com/user-attachments/assets/296c9eb0-799d-4a44-8f22-4a736c4f4b59" />
